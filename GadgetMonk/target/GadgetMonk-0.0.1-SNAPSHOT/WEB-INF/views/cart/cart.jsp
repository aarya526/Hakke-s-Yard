...
<td><a href="<c:url value='/cart/deletecartitem/${cartItem.itemId }'></c:url>" class="btn btn-danger" pull-left>Remove</a></td>
...
<c:if test="${ !empty(cartItems) }">
<a href="<c:url value='/cart/shippingaddress'></c:url>" class="btn btn-success pull-right">
