                ...
                <tbody>
                   <c:forEach items = "${cartItems }" var = "cart">
                    <tr>
                        ...
                        <div class="media">
                            <a class="img img-thumbnail pull-left" > <img style = "width:200px;"class="media-object" src="${pageContext.request.contextPath }/resources/${cart.product.imageUrl}" style="width: 72px; height: 72px;"> </a>
