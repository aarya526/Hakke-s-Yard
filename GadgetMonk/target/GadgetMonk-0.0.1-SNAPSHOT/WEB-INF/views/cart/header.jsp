...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="${pageContext.request.contextPath }/all/register"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="${pageContext.request.contextPath }/admin/category/list">Category List</a></li>
      <li><a href="${pageContext.request.contextPath }/gallery">Add New Category</a></li>
    </ul>
    </security:authorize>
    <ul class="nav navbar-nav navbar-right">
    <security:authorize access = "hasRole('ROLE_USER')">
