   ...
   data-toggle="collapse" data-target="#collapse-example" aria-expanded="false">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="">
              <img src="<c:url value='/resources/images/niit.jpg'></c:url>" alt="NIIT" height="30px" width="60px">
            </a>
		</div>
		...
		<li><a href="<c:url value='/all/register'></c:url>">SignUp</a></li>
		<li><a href="<c:url value='/loginPage'></c:url>">Sign In</a></li>
		</c:if>
