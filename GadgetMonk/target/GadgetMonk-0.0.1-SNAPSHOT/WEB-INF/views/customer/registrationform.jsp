...
<div class = "container" style = "width:450px; height:auto; ">
 ...
 <c:url value = "/save" var = "addUrl"/>
  ...
  <hr>
   ...
   <form:input id = "BillingApartmentnumber" class = "form-control" type = "text" path="billingaddress.apartmentnumber" placeholder = "Enter Apartmentnumber"/>
   ...
   <form:input id = "BillingStreetname" class = "form-control" type = "text" path="billingaddress.streetname" placeholder = "Enter Streetname"/>
   ...
   <form:input id = "BillingCity" class = "form-control" type = "text" path="billingaddress.city" placeholder = "Enter City"/>
   ...
   <form:input id = "BillingState" class = "form-control" type = "text" path="billingaddress.state" placeholder = "Enter State"/>
   ...
   <form:input id = "BillingCountry" class = "form-control" type = "text" path="billingaddress.country" placeholder = "Enter Country"/>
   ...
   <form:input id = "BillingZipcode" class = "form-control" type = "text" path="billingaddress.zipcode" placeholder = "Enter Zipcode"/>
   ...
   <form:input id = "ShippingApartmentnumber" class = "form-control" type = "text" path="shippingaddress.apartmentnumber" placeholder = "Enter Apartmentnumber"/>
   ...
   <form:input id = "ShippingStreetname" class = "form-control" type = "text" path="shippingaddress.streetname" placeholder = "Enter Streetname"/>
   ...
   <form:input id = "ShippingCity" class = "form-control" type = "text" path="shippingaddress.city" placeholder = "Enter City"/>
   ...
   <form:input id = "ShippingState" class = "form-control" type = "text" path="shippingaddress.state" placeholder = "Enter State"/>
   ...
   <form:input id = "ShippingCountry" class = "form-control" type = "text" path="shippingaddress.country" placeholder = "Enter Country"/>
   <form:errors style = "margin-left:100px;" class = "error" path = "shippingaddress.city"/>
   <form:label path="shippingaddress.zipcode">Enter Zipcode: </form:label>
   <form:input id = "ShippingZipcode" class = "form-control" type = "text" path="shippingaddress.zipcode" placeholder = "Enter Zipcode"/>
...
<script type = "text/javascript">
 function setShipping(checked){
	 if(checked){
		 ...
		 document.getElementById('ShippingStreetname').value = document.getElementById('BillingStreetname').value;
		 ...
		 document.getElementById('ShippingStreetname').value = '';
