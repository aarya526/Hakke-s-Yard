...
<body background = "${pageContext.request.contextPath }/resources/images/Playstation images/GalleryW.jpg">
		...
		<div class="row">
				...
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="${pageContext.request.contextPath }/resources/${product.imageUrl}" alt="194x228" class="img-responsive"> 
						<span class="tag2 hot">
							HOT
						</span>
					</div>
				...
				<div class="product-deatil">
						<h5 class="name">
							<a href="#">
								<b>${product.productname }</b> <span>Category: <b>${product.category.categoryname }</b></span>
							</a>
						</h5>
				...
				<div class="description">
					...
					<label>Brand: ${product.company }</label>
					<br>
