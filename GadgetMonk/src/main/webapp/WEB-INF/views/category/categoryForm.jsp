...
<div class = "container" style = "width:450px; margin-top:50px; background-color:lightgrey; border-radius:5px;">
...
<spring:url value="/admin/category/save" var="saveURL" />
  ...
  <div class="form-group">
    ...
    <form:input class="form-control" placeholder="Enter Categoryname" path="categoryname"/>
