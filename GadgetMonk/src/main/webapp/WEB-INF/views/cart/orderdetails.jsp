...
<tr>
<c:url value="/resources/${cartItem.product.imageUrl }" var="imgUrl"></c:url>
<td><img src="${imgUrl }" height="50px" width="100px"> </td>
...
<a class = "btn btn-success" href = "${pageContext.request.contextPath }/gallery">Continue Shopping</a>
</div>
