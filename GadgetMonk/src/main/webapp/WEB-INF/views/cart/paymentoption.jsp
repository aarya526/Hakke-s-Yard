...
<div class = "container" style = "background-color:lightgrey; width:450px; height:570px; margin-top:50px;">

<h3>Payment Method</h3>
<form action = "${pageContext.request.contextPath }/cart/createorder" method = "POST">
...
<div class = "form-group">
 ...
 <input type = "text" class = "form-control" name = "name" placeholder = "Enter Cardholder's name"/>
</div>
<div class = "form-group">
 <label>Debit/Credit Card Number: </label>
 <input type = "text" class = "form-control" name = "number" placeholder = "Enter Card Number"/>
</div>
<div class = "form-group">
...
<div class = "form-group">
 <a href = "${pageContext.request.contextPath }/cart/purchaseDetails" class = "btn btn-danger ">Cancel</a>
 &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
