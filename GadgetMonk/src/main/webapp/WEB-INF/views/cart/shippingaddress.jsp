...
<form:form action = "${pageContext.request.contextPath }/cart/createorder" modelAttribute = "shippingaddress">
 ...
 <form:hidden path="id"/>
  <tr>
   ...
   <td><form:input class = "form-control" type = "text" path="apartmentnumber" value = "${shippingaddress.apartmentnumber }"/></td>
  </tr>
  <tr>
   <td>Streetname :</td>
   <td><form:input class = "form-control" type = "text" path="streetname"/></td>
  </tr>
  <tr>
   <td>City: </td>
   <td><form:input class = "form-control" type = "text" path="city"/></td>
  </tr>
  <tr>
   <td>State: </td>
   <td><form:input class = "form-control" type = "text" path="state"/></td>
  </tr>
  <tr>
   <td>Country</td>
   <td><form:input class = "form-control" type = "text" path="country"/></td>
  </tr>
  <tr>
   <td>Zipcode: </td>
