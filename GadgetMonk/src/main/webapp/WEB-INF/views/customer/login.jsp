...
<div class="container" style = "width: 450px; height:auto; margin-top:120px;">
<div class="login">
...
<button type="submit" name="submit" class=" btn btn-primary" style="width:300px; border-radius:5px; margin-bottom:20px;"><b>Login</b></button>
